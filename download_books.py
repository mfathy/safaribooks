...
Uses the main oreilly_books CLI in a serial manner with progress tracking
"""
...
class BookDownloader:
    """Downloads books from discovered book IDs using serial processing"""
    ...
    def download_single_book(self, book_info: Dict, skill_name: str, skill_dir: Path) -> bool:
        """Download a single book using the main CLI functionality"""
        ...
        try:
            ...
            # Create args for OreillyBooks (simulating CLI usage)
            class Args:
            ...
            try:
                # Run the main downloader (same as CLI)
                OreillyBooks(args)
