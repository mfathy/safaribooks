...
# coding: utf-8
"""
Authentication and Session Management Module for SafariBooks
...
class AuthManager:
    ...
    def do_login(self, email, password):
        ...
        redirect_uri = self.API_ORIGIN_URL + quote_plus(next_parameter)
    ...
    def check_login(self):
        ...
        response = self.requests_provider(self.PROFILE_URL, perform_redirect=False)
